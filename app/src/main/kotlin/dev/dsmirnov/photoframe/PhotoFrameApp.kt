package dev.dsmirnov.photoframe

import android.app.Application
import android.content.pm.ApplicationInfo
import dev.dsmirnov.photoframe.data.FrameStore
import dev.dsmirnov.photoframe.data.IdentityStore
import dev.dsmirnov.photoframe.data.SendDatabase
import dev.dsmirnov.photoframe.data.Settings
import dev.dsmirnov.photoframe.device.FrameConnectionManager
import dev.dsmirnov.photoframe.device.NsdDiscovery
import dev.dsmirnov.photoframe.device.WifiSocketFactory
import dev.dsmirnov.photoframe.diag.EventLog
import dev.dsmirnov.photoframe.gallery.GalleryRepository
import dev.dsmirnov.photoframe.media.ImagePipeline
import dev.dsmirnov.photoframe.send.SendNotifications
import dev.dsmirnov.photoframe.send.SendQueue
